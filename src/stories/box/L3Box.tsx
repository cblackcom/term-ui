...
// this is a component that the rule is not picking up on
// oxlint-disable-next-line react/only-export-components
export const L2BoxContent = styled.div<L2BoxContentProps>(
		...
		<L3BoxRoot size={size} disabled={disabled}>
			<L2BoxContent backgroundColor={backgroundColor}>
				<div>
					...
					incididunt ut labore et dolore magna aliqua. Proin tortor purus platea sit eu id
					nisi litora libero. Neque vulputate consequat ac amet augue blandit maximus
					aliquet congue. Pharetra vestibulum posuere ornare faucibus fusce dictumst orci
					aenean eu facilisis ut volutpat commodo senectus purus himenaeos fames primis
					convallis nisi.
				</div>
